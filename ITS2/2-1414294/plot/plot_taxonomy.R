...
meta <- read.table("Coprophile_meta.tab",header=T,sep="\t",row.names=1,
                   stringsAsFactors=FALSE)
otus <- read.table("Coprophile_OTU_pellets.tab",
...
taxmat <- read.table("Coprophile_taxonomy.tab",header=T,sep="\t",row.names=1)
